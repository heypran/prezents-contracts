...
contract NewApp{
    ...
    uint public constant REWARD_PER_SCORE= 0.001 ether; // should be more
    ...
    function updateQuizDetails(uint _quizId,string memory _cid, string memory _title) public{
  ...
  // start quiz 
    function startQuiz(uint _quizId,uint _endTime, uint _rewards) public payable {
        require(_quizId<quizId,"Not a valid ID");
        require(msg.sender == quizIdMapping[_quizId].creator,"Not owner");
